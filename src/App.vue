...
div(class="row g-0")
  TitleForm(
    ...
    @TitleFormValues="getTitleFormValueUpdates"
    @SaveBoard="SaveBoard"
    :validate="validate"
...
div(class="row g-0")
  div(
    ...
    PlayerForm(
      ...
      @PlayerFormValues="getPlayerFormValueUpdates" 
      v-model:playerError="playerError"
      :validate="validate"
      @validPlayers="validPlayers"
      :loadLoading="loadLoading"
    )
  div(
    :class="(!this.viewOnly) ? 'col-lg-9' : ''"
  )
    Field(
      :selectedField="selectedField" 
      v-model:selectedMode="selectedMode" 
      v-model:selectedPlayer="selectedPlayer" 
      v-model:prevSelectedPlayer="prevSelectedPlayer" 
    ...
    PathForm(
      ...
      @PathFormValues="getPathFormValueUpdates" 
      :forcePlayerUpdate="forcePlayerUpdate"
      :validate="validate"
